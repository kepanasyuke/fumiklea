...
Если у вас установлен make, скопируйте Makefile в ту же папку и выполните:

bash
make open    # открыть страницу в браузере
make serve   # запустить сервер на порту 8000
make check   # проверить наличие HTML-файла
...
портретов учёных с Wikimedia Commons

шрифтов и формул (MathJax)
...
Теперь проект полностью готов к демонстрации и распространению. Если нужны будут изменения — пишите.