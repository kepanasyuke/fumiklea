...
# ------------------------- ЦВЕТА -------------------------
# --- ПАЛИТРА ЦВЕТОВ КРИСТИНЫ (АБСОЛЮТНО ВСЕ НА МЕСТЕ) ---
C = {
    ...
    'C_BUDDY_BLUE': [15, 40, 115],   # Добавлено: Приглушенный ночной ультрамарин кузова Бадди
    
    # НОВЫЕ ХОРРОР-ОТТЕНКИ ДЛЯ КРИСТИНЫ КРУПНЫМ ПЛАНОМ:
    'CHR_GLOSS': [255, 60, 70],   # Яркий алый глянец для верхних граней и бликов капота
    'CHR_BASE': [165, 5, 25],     # Тот самый глубокий, сочный вишневый цвет Кристины
    'CHR_SHADOW': [85, 0, 10],    # Мрачная багровая тень для низа крыльев и порогов
    'CHR_SALON': [55, 5, 12],     # Приглушенный интерьер кабины Плимута

    # НОВЫЙ РАЗНОЦВЕТНЫЙ ОБЪЁМНЫЙ ЛЕС:
    'WOOD_NEEDLES': [15, 65, 35], # Глубокий, благородный темно-зеленый цвет хвои
    'WOOD_SHADOW': [5, 35, 15],   # Сверхтемный зеленый для лесной чащи и низа деревьев
    'WOOD_TRUNK': [45, 35, 25]   # Тёмно-коричневая кора для прорисованных стволов
}
